...
/*============== NOMOR ==============*/
global.nomorbot = '6285796708292'
global.nomorown = '6283155997772'
global.namebot = 'ALT BOT V1'
...
/*============== STAFF ==============*/
global.owner = [
  ['6283155997772', 'Yudha Permana', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
/*============== WATERMARK ==============*/
global.wm = 'ALT BOT V.1' //Main Watermark
global.wm2 = '-- ALT BOT V.1'
global.wm3 = ' ALT BOT V.1 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = ` WhatsApp Bot | By YudhaBOT`
...
/*============== STICKER WM ==============*/
global.stickpack = 'ALT BOT V1'
global.stickauth = `By ©YudhaBOT`
